...
df = pd.read_csv(r"D:\course\P\Project4\pythonProject\2\Fish.csv")
...
num_outliers = int(outlier_fraction * len(X_train) / 2)  # 每一侧的异常值数量
...
print("QR Mean average Error of Line 2: ", mae2)
print("QR R-squared (R²) of Line 2:", r_square2)
...
plt.plot(X, m2 * X + b2, label='QR', linestyle='-', color='green')


plt.scatter(x1_mode, Q1_y, color='purple', s=100, label="Q1 Point")
plt.scatter(x2_mode, median_y, color='brown', s=100, label="Median Point")
plt.scatter(x3_mode, Q3_y, color='cyan', s=100, label="Q3 Point")


plt.annotate("Q1", (x1_mode, Q1_y), textcoords="offset points", xytext=(-10, 10), ha='center', color='purple')
plt.annotate("Median", (x2_mode, median_y), textcoords="offset points", xytext=(-10, 10), ha='center', color='brown')
plt.annotate("Q3", (x3_mode, Q3_y), textcoords="offset points", xytext=(-10, 10), ha='center', color='cyan')
